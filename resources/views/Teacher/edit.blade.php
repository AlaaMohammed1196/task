                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <!--begin::Item-->
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="{{url('dashboard/teachers')}}" class="text-white text-hover-white opacity-75 hover-opacity-100">
                                المعلمين
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 mb-4">
                                            <label>الاسم</label>
                                            <input type="text" name="name" placeholder="أسم المعلم" class="form-control" value="{{$teacher->name}}">
                                        </div>
                                        <div class="col-lg-4 mb-4">
                                            <label>البريد الالكتروني</label>
                                            <input type="text" name="email" placeholder="البريد الألكتروني" class="form-control" value="{{$teacher->email}}">
                                        </div>
                                        <div class="col-lg-4 mb-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 mb-4">
                                            ...
                                            <input type="text" name="degree" placeholder="الدرجه العلميه" class="form-control" value="{{$teacher->degree}}">
                                        </div>
                                        <div class="col-lg-4 mb-4">
                                            <label>تاريخ الميلاد</label>
                                            <input type="date" name="birth_date" placeholder="البريد الألكتروني" class="form-control" value="{{$teacher->birth_date}}">
                                        </div>
