        ...
        <div class="subheader py-2 py-lg-12  subheader-transparent " id="kt_subheader">
            <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <!--begin::Button-->
                                    <a href="{{url('dashboard/teachers/create')}}" class="btn btn-white font-weight-bold py-3 px-6"> أضافه </a>
                <!--end::Button-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" name="birth_date"  id="birth_date" class="form-control" placeholder="تاريخ الميلاد"/>
...
@push('js')
   <script src="{{url('/dashboard')}}/assets/js/pages/crud/teacher.js"></script>
@endpush
