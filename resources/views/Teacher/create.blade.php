                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 mb-4">
                                                <label>الاسم</label>
                                                <input type="text" name="name" placeholder="أسم المعلم" class="form-control">
                                            </div>
                                            <div class="col-lg-4 mb-4">
                                                <label>البريد الالكتروني</label>
                                                <input type="text" name="email" placeholder="البريد الألكتروني" class="form-control">
                                            </div>
                                            <div class="col-lg-4 mb-4">
                                     ...
                                     <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 mb-4">
                                                ...
                                                <input type="text" name="degree" placeholder="الدرجه العلميه" class="form-control">
                                            </div>
                                            <div class="col-lg-4 mb-4">
                                                <label>تاريخ الميلاد</label>
                                                <input type="date" name="birth_date" placeholder="البريد الألكتروني" class="form-control">
                                            </div>
